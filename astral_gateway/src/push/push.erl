...
init([]) ->
    ...
    PushEnabled = astral_gateway_env:get(push_enabled),
    BaseState = #{
    ...
    case PushEnabled of
        true ->
            UgsMaxMb = astral_gateway_env:get(push_user_guild_settings_cache_mb),
            PsMaxMb = astral_gateway_env:get(push_subscriptions_cache_mb),
            BiMaxMb = astral_gateway_env:get(push_blocked_ids_cache_mb),
            BcMaxMb = astral_gateway_env:get(push_badge_counts_cache_mb),
            BcTtl = astral_gateway_env:get(push_badge_counts_cache_ttl_seconds),
            {ok, BaseState#{
