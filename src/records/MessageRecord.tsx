...
import type {MessageComponents} from '~/records/MessageComponentTypes';
...
export class MessageRecord {
	...
	readonly components: MessageComponents | null;
	...
	constructor(message: Message, options?: MessageRecordOptions) {
		...
		this.components = message.components && message.components.length > 0 ? message.components : null;
		...
		return new MessageRecord(
			{
				...
				components: updates.components ?? this.components ?? undefined,
