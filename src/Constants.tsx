...
export const ASTRAL_EPOCH = 1420070400000;
export const ME = '@me';
export const FAVORITES_GUILD_ID = '1337';
export const ASTRALBOT_ID = '0';
...
export const FEATURE_FLAG_GLOBAL_GUILD_ID = '*';
...
export const isGuildStageChannelType = (type: number): boolean => type === ChannelTypes.GUILD_STAGE;
...
export const MessageFlags = {
	SUPPRESS_EMBEDS: 1 << 2,
	/*
	 * EPHEMERAL — Discord interaction-response flag. Messages flagged
	 * ephemeral are intended to be visible only to the user who
	 * triggered the interaction. We filter them client-side for
	 * everyone except the author and explicit mentions until we have
	 * proper interaction-response tracking server-side.
	 */
	EPHEMERAL: 1 << 6,
...
export const APIErrorCodes = {
	...
	UNKNOWN_PREMIUM_WAITLIST_ENTRY: 'UNKNOWN_PREMIUM_WAITLIST_ENTRY',
	...
	NO_USERS_WITH_ASTRALTAG_EXIST: 'NO_USERS_WITH_ASTRALTAG_EXIST',
