...
function generateGuildTextPermissionSpec(i18n: I18n): PermissionSpec {
	return {
		...
		permissions: [
			...
			{
				title: i18n._(msg`Send Voice Messages`),
				description: i18n._(msg`Allow recording and sending voice messages in text chat.`),
				flag: Permissions.SEND_VOICE_MESSAGES,
			},
			{
