		...
		<div className={styles.card}>
			...
			<div className={styles.cardBody}>
				...
				>
					...
					{selectedType === 'message' && (
						<>
							<Input
								...
								placeholder="https://astraof.com/channels/..."
								autoComplete="off"
					...
					<Input
						label={t`Your AstralTag (optional)`}
						type="text"
						value={formValues.reporterAstralTag}
						onChange={(e) => onFieldChange('reporterAstralTag', e.target.value)}
						placeholder="username#1234"
						error={fieldErrors.reporterAstralTag}
					/>
