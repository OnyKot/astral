		...
		<div className={styles.errorFallbackContainer}>
			...
			<div className={styles.errorFallbackContent}>
				...
				<p className={styles.errorFallbackDescription}>
					<Trans>Astral failed to start properly. This could be due to corrupted data or a temporary issue.</Trans>
				</p>
				{error && (
				...
				<p className={styles.errorFallbackDescription}>
					<Trans>
						Check our{' '}
						<a href="https://bsky.app/profile/astraof.com" target="_blank" rel="noopener noreferrer">
							Bluesky
						</a>{' '}
						for status updates.
					</Trans>
