			...
			return (
				<div className={styles.userPreview}>
					<div className={styles.userInfo}>
						...
						<span className={styles.discriminator}>#{context.user.discriminator?.toString() ?? '0'}</span>
					</div>
				</div>
			);
		}
			...
			<Modal.Content>
				<div className={styles.container}>
					<p className={styles.description}>
						<Trans>
							Thank you for helping keep Astral safe. Reports are reviewed by our Safety Team. False reports may result
