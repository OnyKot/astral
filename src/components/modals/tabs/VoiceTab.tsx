					...
					modal(() => (
						<ConfirmModal
							...
							description={
								<p>
									<Trans>
										In your browser, Push-to-Talk will only work when the Astral tab is focused. For system-wide
							...
							onPrimary={() => {
								void openExternalUrl('https://astraof.com/download');
							}}
							onSecondary={() => {
						...
						<div className={styles.deviceNoticeText}>
							...
							<p className={styles.deviceNoticeDescription}>
								{permissionStatus === 'denied' ? (
									isNativeAndroid ? (
										<Trans>
											Allow Astral to use your microphone in Android app settings so calls, voice rooms, and mic
											tests work reliably.
										</Trans>
									) : isNativeDesktop ? (
										<Trans>
											Allow Astral to access your microphone in System Settings / Privacy &amp; Security / Microphone.
										</Trans>
									) : (
										<Trans>
											Allow Astral to access your microphone. Check your browser address bar or settings to enable
											permissions.
										</Trans>
									)
								) : (
									<Trans>Astral needs access to list the available microphones and speakers.</Trans>
								)}
							</p>
						</div>
						<Button
							...
							small={true}
							onClick={() => {
								if (permissionStatus === 'denied' && isNativeAndroid) {
									void openNativePermissionSettings('microphone');
									return;
								}
								void requestPermission();
							}}
						>
							{permissionStatus === 'denied' && isNativeAndroid ? (
								<Trans>Open Android settings</Trans>
							) : (
								...
								link={
									!isNativeDesktop
										? {
												...
												onClick: () => void openExternalUrl('https://astraof.com/download'),
											}
										: {
