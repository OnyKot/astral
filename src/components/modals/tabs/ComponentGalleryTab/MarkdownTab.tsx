	...
	const createMarkdownPreviewMessages = React.useCallback(() => {
		...
		const markdownSections = [
			...
			},
			{
				title: t`Links`,
				items: [
					{label: '[text](url)', content: '[Masked Link](https://astraof.com)'},
					{label: '<url>', content: '<https://astraof.com>'},
					{label: 'url', content: 'https://astraof.com'},
					{label: '<email>', content: '<contact@astraof.com>'},
				],
			},
			{
				title: t`Lists`,
			...
			},
			{
				...
				items: [
					...
					{label: 'Unicode Emojis', content: 'рџЋ‰ рџљЂ вќ¤пёЏ рџ‘Ќ рџЂ'},
