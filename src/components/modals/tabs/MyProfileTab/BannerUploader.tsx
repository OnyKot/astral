...
import {PaintBrushIcon, SparkleIcon} from '@phosphor-icons/react';
					...
					{bannerMode === 'custom' && (
						<div className={styles.buttonGroup}>
							<Button
								...
								leftIcon={<PaintBrushIcon weight="fill" className={styles.paintIcon} />}
								rightIcon={<SparkleIcon weight="fill" className={styles.sparkleIcon} />}
							>
