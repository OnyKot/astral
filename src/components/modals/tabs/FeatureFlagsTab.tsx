...
import {ALL_FEATURE_FLAGS, FEATURE_FLAG_GLOBAL_GUILD_ID, type FeatureFlag, FeatureFlags} from '~/Constants';
...
const FeatureFlagCard: FC<{flag: FeatureFlag; meta: FeatureFlagMeta}> = observer(({flag, meta}) => {
	...
	const guildIds = FeatureFlagStore.getGuildIdsForFlag(flag);
	const enabledForEveryone = guildIds.includes(FEATURE_FLAG_GLOBAL_GUILD_ID);
			...
			<div className={styles.flagHeader}>
				...
				<div className={styles.statusBlock}>
					...
					<p className={styles.guildCount}>
						{enabledForEveryone ? <Trans>Enabled for everyone</Trans> : <Trans>Enabled for {guildCount} guild(s)</Trans>}
					</p>
				</div>
			</div>
