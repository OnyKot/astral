		...
		try {
			...
			if (result === 'granted') {
				...
				ToastActionCreators.createToast({
					type: 'info',
					children: t`Please enable Astral in System Settings → Privacy & Security → Input Monitoring.`,
				});
			}
	...
	return (
		<Modal.Root size="small" centered initialFocusRef={initialFocusRef}>
			...
			<Modal.Content className={styles.content}>
				<p>
					<Trans>
						Astral needs permission to monitor keyboard and mouse input so that <strong>Push-to-Talk</strong> and{' '}
