...
const SEARCHABLE_ITEMS_DESCRIPTORS = [
	...
	{
		id: 'music-library',
		tabType: 'music_connections',
		sectionId: 'services',
		label: msg`Astral Music`,
		keywords: ['astral music', 'music', 'library', 'profile music', 'listening card', 'open music app'],
		description: msg`Use Astral Music directly inside the messenger`,
	},
	{
		id: 'music-sharing',
		tabType: 'music_connections',
		sectionId: 'sharing',
		label: msg`Share listening status`,
		keywords: ['share music', 'presence music', 'profile music', 'listening status', 'astral music label'],
		description: msg`Control whether Astral shows your current Astral Music track`,
	},
	{
		id: 'streaming-twitch-account',
		tabType: 'streaming',
		sectionId: 'twitch-account',
		label: msg`Twitch account`,
		keywords: ['twitch', 'stream', 'creator', 'connect twitch', 'live', 'oauth'],
		description: msg`Connect a Twitch account for creator features`,
	},
	{
		id: 'streaming-stream-mode',
		tabType: 'streaming',
		sectionId: 'stream-mode',
		label: msg`Stream mode`,
		keywords: ['stream mode', 'creator mode', 'screen share', 'privacy overlay', 'broadcast'],
		description: msg`Control creator-safe behavior while streaming`,
	},
	{
		id: 'streaming-streamer-program',
		tabType: 'streaming',
		sectionId: 'streamer-program',
		label: msg`Streamer program`,
		keywords: ['twitch streamer', 'creator program', 'subscriber perks', 'subscriber role', 'creator badge'],
		description: msg`Configure Twitch subscriber perks for an Astral creator community`,
	},
	{
		id: 'streaming-subscriber-access-check',
		tabType: 'streaming',
		sectionId: 'subscriber-perk-check',
		label: msg`Subscriber access check`,
		keywords: ['check subscriber', 'twitch subscriber', 'sub perk', 'verify sub', 'twitch sub'],
		description: msg`Verify whether a linked Twitch account unlocks a creator perk`,
	},
	{
		id: 'streaming-live-automation',
		tabType: 'streaming',
		sectionId: 'live-automation',
		label: msg`Live automation`,
		keywords: ['eventsub', 'live detection', 'announce live', 'twitch presence', 'automation'],
		description: msg`Prepare Twitch live detection and announcements`,
	},
	{
		id: 'appearance-theme',
		tabType: 'appearance',
		sectionId: 'theme',
		label: msg`Theme`,
		keywords: ['theme', 'dark mode', 'light mode', 'dark', 'light', 'coal', 'green', 'gray', 'blue', 'color scheme', 'system theme'],
	...
	{
		id: 'appearance-chat-background',
		tabType: 'appearance',
		sectionId: 'theme',
		label: msg`Chat Background`,
		keywords: ['chat background', 'wallpaper', 'message background', 'chat wallpaper', 'background pattern', 'svg background'],
		description: msg`Choose the repeating background used behind messages`,
	},
	{
	...
	{
		id: 'appearance-style-presets',
		tabType: 'appearance',
		sectionId: 'theme',
		label: msg`Style Presets`,
		keywords: ['style preset', 'preset', 'gradient', 'theme studio', 'aurora', 'sunset', 'ocean', 'forest', 'nebula'],
		description: msg`Choose a preset gradient style`,
	},
	{
	...
	},
	{
		...
		keywords: ['ai', 'assistant', 'grok', '/ai', 'chatbot', 'draft replies'],
		description: msg`Open the full Astral AI workspace powered by Grok`,
	},
	{
		id: 'chat-ai-command',
		tabType: 'chat_settings',
		sectionId: 'ai',
		label: msg`/ai Command`,
		keywords: ['/ai', 'ai command', 'summarize', 'draft', 'reply', 'assistant'],
		description: msg`Use a quick inline AI prompt without opening the workspace`,
	},
	{
	...
	},
	{
		...
		tabType: 'account_integrations',
		sectionId: 'integrations',
		label: msg`Account Linking`,
		keywords: ['integrations', 'account linking', 'connect account', 'linked accounts', 'social accounts', 'identity'],
		description: msg`Connect external services to your Astral profile`,
	},
	{
		...
		sectionId: 'integrations',
		label: msg`Twitch`,
		keywords: ['twitch', 'stream', 'creator', 'live'],
		description: msg`Connect your Twitch account`,
	},
	{
		id: 'integrations-coming-soon',
		tabType: 'account_integrations',
		sectionId: 'integrations',
		label: msg`Upcoming Integrations`,
		keywords: ['youtube', 'x', 'riot', 'steam', 'github', 'tiktok', 'telegram', 'xbox', 'epic games', 'coming soon'],
		description: msg`See integrations that are planned next`,
	},
	...
	},
	{
		...
		tabType: 'notifications',
		sectionId: 'android',
		label: msg`Android Notifications`,
		keywords: ['android', 'mobile app', 'native notifications', 'android alerts', 'notification channels'],
		description: msg`Configure native Android notification behavior`,
	},
	{
		id: 'notifications-android-heads-up',
		tabType: 'notifications',
		sectionId: 'android',
		label: msg`Heads-Up Alerts`,
		keywords: ['heads up', 'banner', 'popup', 'toast', 'android banner', 'alert window'],
		description: msg`Control Android heads-up banners for messages and mentions`,
	},
	{
		id: 'notifications-android-lockscreen',
		tabType: 'notifications',
		sectionId: 'android',
		label: msg`Lockscreen Visibility`,
		keywords: ['lockscreen', 'lock screen', 'privacy', 'screen lock', 'show on lockscreen'],
		description: msg`Choose whether Android can show notification content on the lockscreen`,
	},
	{
		id: 'notifications-android-calls',
		tabType: 'notifications',
		sectionId: 'android',
		label: msg`Call Actions`,
		keywords: ['calls', 'answer', 'decline', 'hang up', 'quick actions', 'fullscreen calls', 'ringtone'],
		description: msg`Configure Android incoming call behavior and quick actions`,
	},
	{
		id: 'notifications-android-channels',
		tabType: 'notifications',
		sectionId: 'android',
		label: msg`Notification Channels`,
		keywords: ['channels', 'message channel', 'mention channel', 'call channel', 'system channel', 'android system settings'],
		description: msg`Open Android channel-specific notification settings`,
	},
	{
...
function createSearchableItems(): Array<SearchableSettingItem> {
	return SEARCHABLE_ITEMS_DESCRIPTORS.filter((item) => {
		if (item.requiresDeveloper) {
			return false;
		}

		if (item.tabType === 'notifications' && item.sectionId === 'android') {
