...
import {DiscoveryApplicationSection} from './sections/DiscoveryApplicationSection';
import {DiscoveryVisibilitySection} from './sections/DiscoveryVisibilitySection';
			...
			<Form form={form} onSubmit={handleSave}>
				...
				{isMobileLayoutEnabled ? (
					<>
						...
						<DiscoveryVisibilitySection form={form} canManageGuild={canManageGuild} />
						<DisallowUnclaimedAccountsSection form={form} canManageGuild={canManageGuild} />
						<DiscoveryApplicationSection guildId={guildId} canManageGuild={canManageGuild} />
					</>
				) : (
					<>
						<IdleSettingsSection form={form} canManageGuild={canManageGuild} voiceChannels={voiceChannels as any} />
