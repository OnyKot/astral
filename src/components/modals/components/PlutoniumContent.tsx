...
import {ReferralProgramSection} from './plutonium/ReferralProgramSection';
		...
		<div className={styles.mainContainer}>
			...
			<div className={styles.header}>
				<div className={styles.iconContainer}>
					<span className={styles.titlePlanet} aria-hidden>
						<span className={styles.titlePlanetCore} />
						<span className={styles.titlePlanetRing} />
						<span className={styles.titlePlanetMoon} />
					</span>
				</div>
				<h1 className={styles.title}>
					<Trans>Astral Plutonium</Trans>
				</h1>
