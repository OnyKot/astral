	...
	return (
		<div className={styles.scrollIndicatorLayer}>
			<AnimatePresence initial={false}>
				{topIndicator && (
					<div key="scroll-indicator-top" className={clsx(styles.indicatorSlot, styles.indicatorSlotTop)}>
				...
				{bottomIndicator && (
					<div key="scroll-indicator-bottom" className={clsx(styles.indicatorSlot, styles.indicatorSlotBottom)}>
						<FloatingScrollIndicator
							direction="bottom"
