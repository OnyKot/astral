...
interface ScrollerProps {
	...
	/*
	 * Opt-in linear-gradient mask on the top/bottom edges of the
	 * scroll content so long lists feel like they extend off-screen
	 * instead of clipping abruptly. Off by default because it changes
	 * how text is painted on the boundary and a few existing scrollers
	 * (e.g. message list with sticky headers) rely on solid edges.
	 */
	edgeFades?: boolean;
	style?: CSSProperties;
