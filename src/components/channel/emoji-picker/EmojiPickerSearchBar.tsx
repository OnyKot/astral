...
export const EmojiPickerSearchBar = observer(
	({
		...
		const placeholder = t`Find the emoji of your dreams`;
		...
		return (
			<div className={clsx(styles.container, compact && styles.containerCompact, className)}>
				<PickerSearchInput
					value={searchTerm}
