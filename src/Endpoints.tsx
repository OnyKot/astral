...
export const Endpoints = {
	INSTANCE: '/instance',
	GEOIP: '/geoip',
	USER_INTEGRATIONS: (userId: string) => `/users/${userId}/integrations`,

	RIOT_CONNECTION: '/users/@me/integrations/riot',
	RIOT_CONNECT: '/users/@me/integrations/riot/connect',
	RIOT_REFRESH: '/users/@me/integrations/riot/refresh',
	...
	AUTH_PHONE_SEND_VERIFICATION: '/auth/phone/send-verification',
	...
	GUILD_DISCOVERY: '/guilds/discovery',
	DISCOVERY_GUILD_JOIN: (guildId: string) => `/discovery/guilds/${guildId}/join`,
	DISCOVERY_GUILD_JOIN_REQUEST: (guildId: string) => `/discovery/guilds/${guildId}/join-request`,
	...
	GUILD_DISCOVERY_VISIBILITY: (guildId: string) => `/guilds/${guildId}/discovery-visibility`,
	GUILD_DISCOVERY_APPLICATION: (guildId: string) => `/guilds/${guildId}/discovery-application`,
	...
	PREMIUM_REFERRALS_SUMMARY: '/premium/referrals/summary',
	...
	PREMIUM_WAITLIST: '/users/@me/premium/waitlist',
	STRIPE_CHECKOUT_SUBSCRIPTION: '/stripe/checkout/subscription',
	STRIPE_CHECKOUT_GIFT: '/stripe/checkout/gift',
	WATA_ORDER_RECONCILE: (orderId: string) => `/payments/wata/orders/${encodeURIComponent(orderId)}/reconcile`,

	MUSIC_AUTH_START: '/music/auth/start',
	MUSIC_AUTH_SESSION: '/music/auth/session',
	MUSIC_AUTH_LOGOUT: '/music/auth/logout',
	...
	USER_AI_CHAT: '/users/@me/ai/chat',
	USER_AI_IMAGES: '/users/@me/ai/images',
	...
	USER_MODAL_LINK: '/links/user-modal',
	USER_PROFILE: (query = ME) => `/users/${query}/profile`,
	USER_ACTIVITY: (userId: string) => `/users/${userId}/activity`,
	STORIES_FEED: '/stories/feed',
	STORIES: '/stories',
	STORY: (storyId: string) => `/stories/${storyId}`,
	STORY_VIEW: (storyId: string) => `/stories/${storyId}/view`,
	STORY_REACTION: (storyId: string) => `/stories/${storyId}/reactions`,
	...
	STEAM_CONNECTION: '/users/@me/integrations/steam',
	STEAM_OPENID_START: '/users/@me/integrations/steam/openid/start',
	STEAM_REFRESH: '/users/@me/integrations/steam/refresh',
	STEAM_PRESENCE_PRIVACY: '/users/@me/integrations/steam/presence/privacy',
	TELEGRAM_CONNECTION: '/users/@me/integrations/telegram',
	TELEGRAM_VERIFY: '/users/@me/integrations/telegram/verify',
	TELEGRAM_PREFERENCES: '/users/@me/integrations/telegram/preferences',
	TELEGRAM_2FA_SETUP: '/users/@me/integrations/telegram/2fa/setup',
	TELEGRAM_2FA_ENABLE: '/users/@me/integrations/telegram/2fa/enable',
	TELEGRAM_2FA_DISABLE: '/users/@me/integrations/telegram/2fa/disable',
	TWITCH_CONNECTION: '/users/@me/integrations/twitch',
	TWITCH_CONNECT_START: '/users/@me/integrations/twitch/oauth/start',
	TWITCH_SETTINGS: '/users/@me/integrations/twitch/settings',
	TWITCH_CREATOR_PROGRAM: '/users/@me/integrations/twitch/creator-program',
	TWITCH_CREATOR_PROGRAMS: '/integrations/twitch/creator-programs',
	TWITCH_EVENTSUB_SYNC: '/users/@me/integrations/twitch/eventsub/sync',
	TWITCH_LIVE_STATE: '/users/@me/integrations/twitch/live-state',
	TWITCH_SUBSCRIBER_PERK_GRANTS: '/users/@me/integrations/twitch/subscriber-perks/grants',
	TWITCH_SUBSCRIBER_PERK_CHECK: '/users/@me/integrations/twitch/subscriber-perks/check',
	TWITCH_DISCONNECT: '/users/@me/integrations/twitch/disconnect',
	USER_MUSIC_STATE: '/users/@me/music/state',
	USER_MUSIC_PLAYBACK: '/users/@me/music/playback',
	...
	INTERACTION_CLICK: '/interactions/click',
