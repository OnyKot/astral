...
import {filterSettingsTabsByAccess} from '~/components/modals/utils/settingsTabFilters';
...
class QuickSwitcherStore {
	...
	private buildCandidateSets(): CandidateSets {
		...
		const accessibleTabs = filterSettingsTabsByAccess(getSettingsTabs((msg) => this.i18n!._(msg)), {
			isDeveloper: DeveloperModeStore.isDeveloper,
