			...
			modal(() => (
				<ConfirmModal
					...
					description={
						deviceType === 'input' ? (
							<Trans>
								Astral has found a new audio input device named <strong>{deviceName}</strong>. Do you want to switch to
								it?
							</Trans>
						) : (
							<Trans>
								Astral has found a new audio output device named <strong>{deviceName}</strong>. Do you want to switch to
								it?
							</Trans>
						)
					}
