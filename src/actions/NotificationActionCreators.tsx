...
export const permissionDenied = (i18n: I18n, suppressModal = false): void => {
	...
	const title = isNativeAndroidApp() ? i18n._(msg`Android Notifications Blocked`) : i18n._(msg`Notifications Blocked`);
	const description = isNativeAndroidApp() ? (
		<p>
			<Trans>
				Android notifications are blocked. You can enable them later in Android system settings or under User Settings
		...
		<p>
			<Trans>
				Desktop notifications have been blocked. You can enable them later in your browser settings or in User Settings
				&gt; Notifications.
			</Trans>
		</p>
	);
