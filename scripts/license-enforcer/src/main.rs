 ...
 * Copyright (C) {year} Astral Contributors
 *
 * This file is part of Astral.
 *
 * Astral is free software: you can redistribute it and/or modify
...
const ERLANG_LICENSE_HEADER: &str = r"%% Copyright (C) {year} Astral Contributors
%%
%% This file is part of Astral.
%%
%% Astral is free software: you can redistribute it and/or modify
...
const GLEAM_LICENSE_HEADER: &str = r"//// Copyright (C) {year} Astral Contributors
////
//// This file is part of Astral.
////
//// Astral is free software: you can redistribute it and/or modify
...
const SHELL_LICENSE_HEADER: &str = r"# Copyright (C) {year} Astral Contributors
#
# This file is part of Astral.
#
# Astral is free software: you can redistribute it and/or modify
...
impl Processor {
    ...
    fn should_ignore(&self, path: &str) -> bool {
        if path.contains("Astral_static") {
            return true;
        }
    ...
    fn detect_license(&self, content: &str) -> (bool, Option<i32>) {
        ...
        (has_agpl && has_Astral, detected_year)
    }
