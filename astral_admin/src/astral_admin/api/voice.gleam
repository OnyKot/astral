...
fn voice_region_decoder() {
  ...
  use is_default <- decode.optional_field("is_default", False, decode.bool)
  use vip_only <- decode.optional_field("vip_only", False, decode.bool)
  use required_guild_features <- decode.optional_field(
    "required_guild_features",
    [],
    decode.list(decode.string),
  )
  use allowed_guild_ids <- decode.optional_field(
    "allowed_guild_ids",
    [],
    decode.list(decode.string),
  )
  use allowed_user_ids <- decode.optional_field(
    "allowed_user_ids",
    [],
    decode.list(decode.string),
  )
...
fn voice_server_decoder() {
  ...
  use is_active <- decode.optional_field("is_active", False, decode.bool)
  use vip_only <- decode.optional_field("vip_only", False, decode.bool)
  use required_guild_features <- decode.optional_field(
    "required_guild_features",
    [],
