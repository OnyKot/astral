  ...
  h.div(
    ...
    [
      h.div(
        ...
        [
          h.div([a.class("flex items-start sm:items-center gap-3 min-w-0")], [
            ...
            h.div([a.class("min-w-0")], [
              ...
              h.p([a.class("text-sm text-neutral-600 break-all")], [
      ...
      h.div(
        [a.class("grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4")],
        [
      ...
      h.div([a.class("mt-4 flex flex-col sm:flex-row gap-2")], [
        h.form([a.method("POST"), a.action("?action=delete&id=" <> region.id)], [
          h.button(
            [
              a.type_("submit"),
              a.class(
                "px-3 py-1.5 bg-red-600 text-white text-sm rounded hover:bg-red-700 transition-colors w-full",
              ),
              a.attribute(
                "onclick",
        ...
        h.a(
          [
            ...
            a.class(
              "px-3 py-1.5 bg-neutral-100 text-neutral-900 text-sm rounded hover:bg-neutral-200 transition-colors text-center w-full",
            ),
          ],
...
fn render_server_row(_ctx: Context, server: voice.VoiceServer) {
  h.div(
    [
      a.class(
        "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 p-3 bg-neutral-50 rounded",
      ),
    ],
    [
      h.div([a.class("flex-1")], [
        h.p([a.class("text-sm text-neutral-900 break-all")], [
          element.text(server.server_id),
        ]),
        h.p([a.class("text-xs text-neutral-600 break-all")], [
      ...
      [
        ...
        h.div([a.class("space-y-2")], [
          h.label([a.class("flex items-center gap-2")], [
            h.input(
              [
                [a.type_("checkbox"), a.name("is_default"), a.value("true")],
                case region.is_default {
                  True -> [a.checked(True)]
                  False -> []
                },
