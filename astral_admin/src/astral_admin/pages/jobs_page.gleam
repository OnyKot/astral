...
import astral_admin/web.{
  type Context, type Session, cache_busted_asset, prepend_base_path,
}
    ...
    h.div(
      ...
      [
        h.p([a.class("text-yellow-800")], [
          element.text(
            "Metrics service not configured. Set ASTRAL_METRICS_HOST to enable.",
          ),
        ]),
      ],
    ),
      ...
      h.div(
        ...
        [
          h.div([a.class("p-6")], [
            ...
            ui.text_small_muted("Processing time distribution (p50, p95, p99)"),
            h.div([a.class("mt-4")], [
              element.element(
                "canvas",
