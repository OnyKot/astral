...
import astral_admin/api/messages
...
import astral_admin/components/tabs

import astral_admin/components/ui

import astral_admin/constants

import astral_admin/pages/user_detail/handlers

import astral_admin/pages/user_detail/tabs/account

import astral_admin/pages/user_detail/tabs/guilds

import astral_admin/pages/user_detail/tabs/moderation

import astral_admin/pages/user_detail/tabs/overview

import astral_admin/user

import astral_admin/web.{type Context, type Session, action, href, redirect}
...
pub fn handle_action(
  ...
  case action {
    ...
    option.Some("send-passkey-migration-email") ->
      handlers.handle_send_passkey_migration_email(
        ctx,
        session,
        user_id,
        redirect_url,
    ...
    option.Some("reset-passkeys") ->
      handlers.handle_reset_passkeys(ctx, session, user_id, redirect_url)
