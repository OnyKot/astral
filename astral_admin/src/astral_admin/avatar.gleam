...
pub fn get_user_avatar_url(
  ...
  case avatar {
    ...
    option.None -> get_default_avatar_url(cdn_endpoint, user_id, asset_version)
  }
}

pub fn get_default_avatar_url(
  cdn_endpoint: String,
  user_id: String,
  asset_version: String,
) -> String {
...
pub fn get_user_avatar_fallback_onerror(
  cdn_endpoint: String,
  user_id: String,
  asset_version: String,
) -> String {
  "this.onerror=null;this.src='"
  <> get_default_avatar_url(cdn_endpoint, user_id, asset_version)
  <> "';"
}
