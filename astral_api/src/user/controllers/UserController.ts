...
import {UserMusicAuthController} from './UserMusicAuthController';
...
export const UserController = (app: HonoApp) => {
	...
	UserMusicAuthController(app);
	UserMusicController(app);
	UserMusicProxyController(app);
	UserMusicSearchController(app);
