...
export interface IUserContentRepository {
	...
	findPaymentRefsByReferrerUserId(referrerUserId: UserID): Promise<Array<PaymentByReferrerRow>>;
	findPaymentsByReferrerUserId(referrerUserId: UserID): Promise<Array<Payment>>;
