...
export class UserContentRepository implements IUserContentRepository {
	...
	async findPaymentRefsByReferrerUserId(referrerUserId: UserID): Promise<Array<PaymentByReferrerRow>> {
		return this.paymentRepository.findPaymentRefsByReferrerUserId(referrerUserId);
	}

	async findPaymentsByReferrerUserId(referrerUserId: UserID): Promise<Array<Payment>> {
		return this.paymentRepository.findPaymentsByReferrerUserId(referrerUserId);
	}
