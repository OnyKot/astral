...
export type CommandID = Brand<bigint, 'CommandID'>;
...
export const createCommandID = <T extends bigint>(id: T extends BrandedValue ? never : T): CommandID =>
	brand<T, 'CommandID'>(id);
