...
process.env.CASSANDRA_KEYSPACE = 'Astral';
...
process.env.ASTRAL_APP_ENDPOINT = 'https://app.test';
process.env.ASTRAL_GATEWAY_ENDPOINT = 'https://gateway.test';
...
process.env.ASTRAL_GIFT_ENDPOINT = 'https://gift.test';
process.env.ASTRAL_UNFURL_IGNORED_HOSTS = '';
