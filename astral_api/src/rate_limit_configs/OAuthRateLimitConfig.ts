...
export const OAuthRateLimitConfigs = {
	...
	APPLICATION_COMMANDS_LIST: {
		bucket: 'application_commands:list::application_id',
		config: {limit: 60, windowMs: 60000},
	} as RouteRateLimitConfig,

	APPLICATION_COMMANDS_CREATE: {
		bucket: 'application_commands:create::application_id',
		config: {limit: 30, windowMs: 60000},
	} as RouteRateLimitConfig,

	APPLICATION_COMMANDS_UPDATE: {
		bucket: 'application_commands:update::application_id',
		config: {limit: 30, windowMs: 60000},
	} as RouteRateLimitConfig,

	APPLICATION_COMMANDS_DELETE: {
		bucket: 'application_commands:delete::application_id',
		config: {limit: 30, windowMs: 60000},
	} as RouteRateLimitConfig,

	APPLICATION_COMMANDS_BULK_OVERWRITE: {
		bucket: 'application_commands:bulk::application_id',
