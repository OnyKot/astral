...
export class AdminUserService {
	...
	async sendPasskeyMigrationEmail(
		...
		return this.securityService.sendPasskeyMigrationEmail(data, adminUserId, auditLogReason);
	}

	async resetPasskeys(data: ResetPasskeysRequest, adminUserId: UserID, auditLogReason: string | null) {
		return this.securityService.resetPasskeys(data, adminUserId, auditLogReason);
	}
