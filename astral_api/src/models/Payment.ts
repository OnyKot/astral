...
export class Payment {
	...
	readonly referrerUserId: UserID | null;
	...
	constructor(row: PaymentRow) {
		...
		this.referralCode = row.referral_code ?? null;
		this.referrerUserId = row.referrer_user_id ?? null;
		this.referralRewardCents = row.referral_reward_cents ?? 0;
	...
	toRow(): PaymentRow {
		return {
			...
			referral_reward_cents: this.referralRewardCents,
