...
import {type MessageComponents, parseComponents, serializeComponents} from '~/channel/ComponentTypes';
...
export class Message {
	...
	constructor(row: MessageRow) {
		...
		this.components = parseComponents(row.components ?? null);
	}
	...
	toRow(): MessageRow {
		return {
			...
			components: serializeComponents(this.components),
		};
	}
}
