...
export interface IEmailService {
	...
	sendPasskeyMigrationNotice(email: string, username: string, locale?: string | null): Promise<boolean>;

	sendPasskeyResetNotice(email: string, username: string, locale?: string | null): Promise<boolean>;
}
