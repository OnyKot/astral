...
import {
	...
	APPLICATION_COMMANDS_BY_APPLICATION_COLUMNS,
	type ApplicationCommandRow,
	type ApplicationCommandsByApplicationRow,
	APPLICATION_COLUMNS,
	...
	GUILD_COLUMNS,
	GUILD_DISCOVERY_APPLICATION_COLUMNS,
	GUILD_EMOJI_BY_EMOJI_ID_COLUMNS,
	GUILD_EMOJI_COLUMNS,
	GUILD_JOIN_REQUEST_COLUMNS,
	...
	type GuildDiscoveryApplicationRow,
	type GuildEmojiRow,
...
export const GuildDiscoveryApplications = defineTable<GuildDiscoveryApplicationRow, 'guild_id'>({
...
export const GuildJoinRequests = defineTable<GuildJoinRequestRow, 'guild_id' | 'user_id'>({
	...
	columns: GUILD_JOIN_REQUEST_COLUMNS,
	primaryKey: ['guild_id', 'user_id'],
});
...
export const PaymentsByReferrer = defineTable<PaymentByReferrerRow, 'referrer_user_id' | 'completed_at' | 'checkout_session_id'>({
	name: 'payments_by_referrer',
	columns: PAYMENT_BY_REFERRER_COLUMNS,
	primaryKey: ['referrer_user_id', 'completed_at', 'checkout_session_id'],
});
...
export const ApplicationCommands = defineTable<ApplicationCommandRow, 'command_id'>({
	name: 'application_commands',
	columns: APPLICATION_COMMAND_COLUMNS,
	primaryKey: ['command_id'],
});

export const ApplicationCommandsByApplication = defineTable<
	ApplicationCommandsByApplicationRow,
	'application_id' | 'guild_id' | 'command_id'
>({
	name: 'application_commands_by_application',
	columns: APPLICATION_COMMANDS_BY_APPLICATION_COLUMNS,
	primaryKey: ['application_id', 'guild_id', 'command_id'],
});
