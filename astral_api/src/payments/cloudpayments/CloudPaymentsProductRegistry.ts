...
export interface CloudPaymentsProduct {
	priceId: string;
	type: ProductType;
	premiumType: 1 | 2;
...
export class CloudPaymentsProductRegistry {
	private products = new Map<string, CloudPaymentsProduct>();
	...
	private register(product: CloudPaymentsProduct): void {
	...
	getProduct(priceId: string): CloudPaymentsProduct | null {
