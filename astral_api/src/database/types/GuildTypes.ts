...
/*
 * Guild discovery moderation queue. Owners submit an application to be
 * listed in /discover; admins approve / reject through the moderation
 * panel. Approved guilds get the DISCOVERY_APPROVED feature flag and
 * become visible to discovery search.
 */
export type GuildDiscoveryApplicationStatus = 'pending' | 'approved' | 'rejected' | 'withdrawn';

export interface GuildDiscoveryApplicationRow {
	guild_id: GuildID;
	...
	review_note: Nullish<string>;
	category: Nullish<string>;
	description: Nullish<string>;
	tags: Nullish<Set<string>>;
}

export const GUILD_DISCOVERY_APPLICATION_COLUMNS = [
	'guild_id',
	'status',
	'submitted_by',
	'submitted_at',
	...
	'description',
	'tags',
] as const satisfies ReadonlyArray<keyof GuildDiscoveryApplicationRow>;

export type GuildJoinRequestStatus = 'pending' | 'approved' | 'rejected' | 'withdrawn';

export interface GuildJoinRequestRow {
	guild_id: GuildID;
	user_id: UserID;
...
export const GUILD_JOIN_REQUEST_COLUMNS = [
	'guild_id',
	'user_id',
	'status',
	'requested_at',
	...
	'reviewed_at',
	'review_note',
] as const satisfies ReadonlyArray<keyof GuildJoinRequestRow>;
