...
export interface PaymentRow {
	...
	referral_code: Nullish<string>;
	referrer_user_id: Nullish<UserID>;
...
export interface PaymentByReferrerRow {
	referrer_user_id: UserID;
	completed_at: Date;
	checkout_session_id: string;
}

export const PAYMENT_BY_REFERRER_COLUMNS = ['referrer_user_id', 'completed_at', 'checkout_session_id'] as const;
