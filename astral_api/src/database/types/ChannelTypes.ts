...
export interface WebhookRow {
	...
	version: number;
	/*
	 * Optional outbound HTTP endpoint that Astral POSTs to when a user
	 * clicks an interactive component (button / select menu) on a message
	 * authored by this webhook. Lets bots receive interaction events
	 * without running a full gateway connection. Null = no interaction
	 * handler; clicks become no-ops.
	 */
	interaction_url: Nullish<string>;
}
