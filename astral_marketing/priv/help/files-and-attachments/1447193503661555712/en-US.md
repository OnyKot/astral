---
title: How attachment expiry works on Astral
...
Astral automatically expires older attachments. Smaller files stay available longer; bigger ones expire sooner. If people view a message with a file when it is close to expiring, we extend it so it stays available.
...
Astral is a messaging service, not a cloud storage platform. We suggest advanced users host files themselves if this is a concern. There are tools that let you upload screenshots or files to your own cloud storage and domain, then share those links on Astral or elsewhere while retaining full control.
...
Astral has a Saved Media feature that lets you keep up to **50** media files (or **500** if you have Plutonium)—images, videos, GIFs, or audio—to access across your accounts. Saved Media is **not** subject to attachment expiry; items you save there stay until you delete them.
