...
These terms of service ("Terms") constitute a legally binding contract between you and Astral Platform AB (Swedish organization number: 559537-3993). We are based in Stockholm County, Sweden, and we operate the Astral chat platform and related services. Throughout these Terms, references to "Astral", "we", "us" or "our" refer to Astral Platform AB and our Services.

By creating an account or using Astral in any way, you agree to be bound by these Terms, our [Privacy Policy](/privacy), and our [Community Guidelines](/guidelines). If you do not agree to these Terms, you must not use Astral.
...
- **"Services"** means the Astral applications (web, mobile, desktop), HTTP and WebSocket APIs, related websites and domains, and any other products, software, features, or services provided by Astral.
...
- **"Plutonium"** means Astral's optional paid subscription offering that provides enhanced features and benefits.
- **"Community"** means a server, space, or similar environment created or administered on Astral where users can communicate or share content.
...
- **"Account"** means a user account registered with Astral that is associated with a unique identifier and, typically, an email address.
- **"Privacy Policy"** means our [Privacy Policy](/privacy), which explains how we collect, use, and protect personal data.
- **"Community Guidelines"** means our [Community Guidelines](/guidelines), which govern acceptable behavior and content on Astral.

Capitalized terms that are not defined in this section have the meaning given to them elsewhere in these Terms.

## 1. Eligibility and Accounts

### 1.1 Eligibility to Use Astral
...
To use most features of Astral, you must create an Account. You are solely responsible for:
...
You must promptly notify us at support@astraof.com if you become aware of any unauthorized access to or use of your Account.
...
These Terms govern your use of Astral as a consumer and for general personal or community use.
...
Astral is a communication and community platform where you can:
...
### 3.2 License to Astral

To operate, secure, and improve the Services, you grant Astral a limited license to your User Content.

Specifically, by submitting, uploading, or otherwise making User Content available on or through the Services, you grant Astral a worldwide, non-exclusive, royalty-free, transferable, and sublicensable license to:
...
If you believe that content on Astral infringes your copyrights, please notify us at dmca@astraof.com with the following information:
...
- use Astral primarily as unlimited cloud storage rather than for communication or community activities;
...
- use Astral infrastructure for command-and-control of malware, botnets, or other harmful systems; or
- deliberately attempt to stress test, overload, or degrade our infrastructure without our prior written permission.

We will not target normal users who are using Astral in good faith for its intended purposes. This policy exists to prevent abuse that harms the platform and other users.
...
By providing a payment method to Astral, you:
...
### 6.2 Astral Plutonium Subscription

We offer an optional premium subscription service called **Astral Plutonium** that provides enhanced features and benefits.
...
You may request a refund within 14 days of purchasing a Plutonium subscription by emailing support@astraof.com from your registered Account email address, unless applicable law grants you a longer or different cooling-off period.
...
- you remain responsible for any unpaid amounts owed to Astral.
...
If you believe there is an error or unauthorized charge on your Account, we encourage you to contact us first at support@astraof.com so we can investigate and attempt to resolve the issue quickly.

If you initiate a chargeback or payment dispute with your bank or payment provider for a payment made to Astral, we may:
...
Astral integrates with and relies upon various third-party services to provide the Services, including hosting and infrastructure providers, payment processors, content delivery networks, security services, and communication platforms.
...
These third-party services have their own independent terms of service and privacy policies. Your use of such services may be subject to those additional terms. Astral is not responsible for the content, availability, policies, or practices of third-party services.
...
You may delete your Astral Account at any time through your Account settings. While we will be sorry to see you go, we respect your choice and will process your deletion request in accordance with our data retention practices and applicable law. For details about the deletion process, including any grace period during which you can cancel deletion, see <% article 1445724566704881664 %>.

### 8.2 Suspension and Termination by Astral
...
If you believe we have made a mistake in suspending or terminating your Account, you may appeal in accordance with our [Community Guidelines](/guidelines), for example by emailing appeals@astraof.com from the email address associated with your Account.
...
You can remove messages and other content through your Privacy Dashboard or by contacting privacy@astraof.com before deletion, subject to technical and legal limitations.

## 9. Disclaimers, Limitation of Liability, and Indemnification

### 9.1 No Warranties

We work diligently to maintain Astral as a reliable and stable platform, but the Services are provided on an "as is" and "as available" basis.

To the fullest extent permitted by law, Astral and its affiliates make no express or implied warranties or representations about the Services, including but not limited to warranties of merchantability, fitness for a particular purpose, non-infringement, or that the Services will be uninterrupted, secure, or error-free.
...
To the maximum extent permitted by applicable law, Astral and its affiliates will not be liable for:
...
- EUR 100; or
- the total amount you have paid to Astral for the Services during the twelve (12) months immediately preceding the event giving rise to the claim.
...
To the extent permitted by applicable law, you agree to defend, indemnify, and hold harmless Astral, its officers, directors, employees, and agents from and against any claims, demands, actions, damages, losses, and expenses (including reasonable legal fees) arising out of or related to:
...
- **Informal resolution first:** If you have a concern or dispute with us, please contact support@astraof.com first. We will try to work with you in good faith to resolve the issue informally.
...
All account-related communications with Astral should be sent from the email address associated with your Account. We use this as our primary method of verifying your identity and ensuring we are communicating with the actual Account holder.
...
Astral will never ask you to provide your password, full payment card number, or other highly sensitive security information via email. All official Astral emails originate from addresses ending in `@astraof.com`. Be cautious of phishing attempts using similar-looking domain names or requesting sensitive information.

If you receive a suspicious message claiming to be from Astral, please do not click any links or provide any information. Instead, contact us directly at support@astraof.com.

## 13. Contact Information

If you have questions, concerns, or need assistance with the Services or these Terms, you can contact us at:

- **Support email:** support@astraof.com (for account-related matters, please contact us from the email address associated with your Account where possible)
- **Privacy email:** privacy@astraof.com (for privacy and data protection requests)
