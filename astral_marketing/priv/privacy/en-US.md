...
- We do not sell, rent, or trade your personal data to third parties. We also do not "sell" or "share" personal information for cross-context behavioral advertising as defined by the CCPA/CPRA in relation to Astral. When you interact with third-party content such as embedded YouTube videos, those third parties may collect and use information under their own privacy policies, which may include advertising in their own services.
...
- We do not train AI models on your messages, files, or any other content you create or share on Astral.
...
- Where we use automated systems that significantly affect your access to Astral (for example, regional eligibility checks based on IP geolocation), we do so in line with applicable law and describe your rights in this policy.
...
We are **Individual Entrepreneur Andreev Ivan Sergeevich** (Russian Federation).

Business details:

- OGRNIP: 324508100385388
- INN: 502991812328
- Entrepreneur type: Individual Entrepreneur
- Registration date: 9 July 2024
- Registrar: Interdistrict Inspectorate of the Federal Tax Service No. 23 for the Moscow Region
- Tax authority: Inspectorate of the Federal Tax Service of Russia for Mytishchi, Moscow Region
- Tax regime: NPD (applied)
- SME status: Microenterprise (included on 10 August 2024)

For Astral services, Individual Entrepreneur Andreev Ivan Sergeevich acts as the data controller, meaning we determine how and why personal data is processed.

You can find our contact details in [Section 16](#16-contact-us).
...
When you use Astral, we automatically collect certain technical and usage information, including:
...
- **Usage information:**
  Information about how you interact with Astral, such as:
...
- To provide, operate, and maintain the Astral platform and services.
...
- To protect the safety, rights, and property of our users, the public, and Astral.

We do not use your messages, files, or any other content you create or share on Astral for targeted advertising or for training AI models.
...
We share your information when you intentionally interact with others on Astral, for example:
...
In these cases, other users can see the information you choose to share, and they may further share or store it outside Astral. We encourage you to be mindful about the content you share and with whom.

### 4.2 With Service Providers

We work with trusted third-party service providers who process data on our behalf to help us operate Astral. These providers include:

- **OVHcloud** вЂ“ primary hosting of our servers in Vint Hill, Virginia, USA.
- **Backblaze** вЂ“ encrypted backups stored in Amsterdam, Netherlands.
- **Cloudflare** вЂ“ content delivery network (CDN) and security services, including:
  - delivery and caching of user-generated content on the `astraof.com` domain;
...
- **Stripe** вЂ“ payment processing for subscriptions and other purchases.
- **Google** вЂ“ Tenor GIF search and YouTube embeds. GIF searches are sent from our servers to the Tenor API so Google does not see your IP address or device identifiers. For YouTube embeds, we fetch metadata server-side and only load a YouTube iframe from your device if and when you choose to play a video.
- **hCaptcha** вЂ“ backup CAPTCHA provider; users can choose hCaptcha instead of Cloudflare Turnstile for bot prevention challenges.
- **Cloudflare Turnstile** вЂ“ primary CAPTCHA provider for bot prevention.
- **Twilio** вЂ“ transactional emails and SMS notifications (for example, login codes, alerts).
- **Fastmail** вЂ“ support email infrastructure.
- **Porkbun** вЂ“ domain registration services.
...
- protect the safety, rights, or property of our users, the public, or Astral; or
...
- Text messages and the main Astral application traffic do not route through this media CDN and are not scanned by this tool.
...
- **User-generated content CDN:**
  Cloudflare edge locations worldwide (for content on the `astraof.com` domain).
...
For active accounts, we generally keep your personal data for as long as you use Astral. This includes your messages, Communities, and other User Content while your account remains active, unless you delete specific content yourself.
...
You have several tools and settings to help you manage your data and privacy on Astral.
...
- Email privacy@astraof.com from the email address associated with your Astral account.
...
- **Rights under CCPA/CPRA (for California residents):**
  ...
  - right to opt out of the sale or sharing of personal information (we do not sell or share personal information for cross-context behavioral advertising in relation to Astral); and
...
You can also contact us at privacy@astraof.com to exercise your rights. When you do so:
...
We use automated systems in certain limited ways that may affect your use of Astral, such as:

- determining whether your approximate location is in a region where access to Astral is permitted based on IP geolocation and applicable laws; and
- detecting potential fraud, spam, or abusive behavior.

These systems can influence, for example, whether you can access Astral from a given region or whether certain actions are temporarily blocked while we investigate potential abuse.

Where applicable law (such as GDPR) grants you rights related to automated decision-making вЂ” such as the right to obtain human review, to express your point of view, or to contest certain decisions вЂ” you can contact us at privacy@astraof.com. We will handle such requests in line with those laws and our legal obligations.

## 11. Children's Privacy

Users must meet the minimum age requirement in their region to create and use a Astral account. We determine eligibility based on your self-reported information and your approximate geographic location.

For the purposes of this policy and our Terms of Service:

- the **minimum age to use Astral** (the "Minimum Age") is the lowest age at which applicable law in your country permits you to use an online service like Astral. This is typically 13 years old, but it varies by country and may be higher in certain jurisdictions; and
- users who are **above the Minimum Age but under the age of legal majority** in their jurisdiction (for example, under 18 in many countries) may use Astral, but our Terms require a parent or guardian to review and agree to them on the user's behalf.
...
If you are a parent or legal guardian and believe that your child has used Astral without your consent or does not meet the Minimum Age requirement, you may contact privacy@astraof.com from the child's registered email address (or with sufficient proof of guardianship) to request deletion of their account and associated data.

## 12. Cookies and Similar Technologies

### 12.1 Astral Application

We do not use third-party advertising or tracking cookies for our own analytics or advertising in the Astral application. Any cookies we set are strictly necessary for the operation and security of the service. We also do not run advertising trackers or analytics SDKs in the app. Operational logging and limited feature-usage telemetry are stored server-side to keep the service reliable and secure and to understand which features are used. This server-side data is not used for advertising or cross-site profiling.
...
On our marketing website (`astraof.com`):
...
Astral may contain links to third-party websites, services, or content (for example, YouTube videos, GIF search, or other embedded content). When you use these features:
...
- Requests should be directed to legal@astraof.com and should clearly identify the requesting authority, legal basis, and scope of data requested.
...
Your continued use of Astral after the updated policy takes effect constitutes your acceptance of the changes. If you do not agree with the updated policy, you should stop using Astral and, if you wish, delete your account.

## 16. Contact Us

For account-related and privacy-related requests, you should contact us from the email address associated with your Astral account wherever possible. This helps us verify your identity and protect your account.

### Privacy and Data Protection Contact

- Email: privacy@astraof.com
- Contact person: Individual Entrepreneur Andreev Ivan Sergeevich
- This is our primary contact point for privacy and data protection questions.
