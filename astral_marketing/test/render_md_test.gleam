...
pub fn render_arabic_header_with_custom_id_test() {
  render_md.render(
    "## مرحبًا بك في Astral {#welcome-to-Astral}",
    "https://example.com",
    locale.Ar,
    empty_help_data(),
  )
  |> should.equal(
    "<h2 id=\"welcome-to-Astral\" style=\"scroll-margin-top: var(--anchor-offset, 200px)\">مرحبًا بك في Astral</h2>",
  )
}
...
pub fn render_actual_bug_case_test() {
  let markdown =
    "**Chromium-based browsers** (Chrome, Edge, Brave, Opera):\n1. Navigate to [asrtal.ru/channels/@me](/channels/@me)\n2. Click the install icon in the address bar, or\n3. Go to browser menu > \"Install Astral\" or \"Add to Desktop\""
  let expected =
    "<p><strong>Chromium-based browsers</strong> (Chrome, Edge, Brave, Opera):</p>\n\n<ol>\n<li>Navigate to <a class=\"text-[#4641D9] hover:underline\" href=\"https://example.com/channels/@me\">asrtal.ru/channels/@me</a></li>\n<li>Click the install icon in the address bar, or</li>\n<li>Go to browser menu &gt; &quot;Install Astral&quot; or &quot;Add to Desktop&quot;</li>\n</ol>"
...
pub fn render_app_variable_replacement_test() {
  ...
  |> should.equal(
    "<p>Visit <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/channels/@me\">asrtal.ru/channels/@me</a></p>",
  )
}
...
pub fn render_app_shortcut_test() {
  ...
  |> should.equal(
    "<p>Go to <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/channels/@me\">asrtal.ru/channels/@me</a></p>",
  )
}
...
pub fn render_app_shortcut_in_list_test() {
  ...
  |> should.equal(
    "<ul>\n<li><a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/channels/@me\">asrtal.ru/channels/@me</a></li>\n<li><a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/login\">asrtal.ru/login</a></li>\n</ul>",
  )
}
...
pub fn render_email_link_test() {
  render_md.render(
    "Contact us at privacy@asrtal.ru",
    "https://example.com",
    locale.EnUS,
    empty_help_data(),
  )
  |> should.equal(
    "<p>Contact us at <a class=\"text-[#4641D9] hover:underline\" href=\"mailto:privacy@asrtal.ru\">privacy@asrtal.ru</a></p>",
  )
}

pub fn render_multiple_email_links_test() {
  render_md.render(
    "Email support@asrtal.ru or privacy@asrtal.ru",
    "https://example.com",
    locale.EnUS,
    empty_help_data(),
  )
  |> should.equal(
    "<p>Email <a class=\"text-[#4641D9] hover:underline\" href=\"mailto:support@asrtal.ru\">support@asrtal.ru</a> or <a class=\"text-[#4641D9] hover:underline\" href=\"mailto:privacy@asrtal.ru\">privacy@asrtal.ru</a></p>",
  )
}

pub fn render_email_in_list_test() {
  render_md.render(
    "- Contact: privacy@asrtal.ru\n- Support: support@asrtal.ru",
    "https://example.com",
    locale.EnUS,
    empty_help_data(),
  )
  |> should.equal(
    "<ul>\n<li>Contact: <a class=\"text-[#4641D9] hover:underline\" href=\"mailto:privacy@asrtal.ru\">privacy@asrtal.ru</a></li>\n<li>Support: <a class=\"text-[#4641D9] hover:underline\" href=\"mailto:support@asrtal.ru\">support@asrtal.ru</a></li>\n</ul>",
  )
}

pub fn render_email_with_other_formatting_test() {
  render_md.render(
    "Email **privacy@asrtal.ru** for questions",
    "https://example.com",
    locale.EnUS,
    empty_help_data(),
  )
  |> should.equal(
    "<p>Email <strong><a class=\"text-[#4641D9] hover:underline\" href=\"mailto:privacy@asrtal.ru\">privacy@asrtal.ru</a></strong> for questions</p>",
  )
}
...
pub fn render_article_shortcut_test() {
  ...
  |> should.equal(
    "<p>For more information, see <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/help/en-us/articles/1445724566704881664-how-to-delete-your-account\">How to delete your account</a>.</p>",
  )
}
...
pub fn render_article_shortcut_french_test() {
  ...
  |> should.equal(
    "<p>Pour plus d&#39;informations, consultez <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/help/fr/articles/1445724566704881664-comment-supprimer-votre-compte\">Comment supprimer votre compte</a>.</p>",
  )
}
...
pub fn render_multiple_article_shortcuts_test() {
  ...
  |> should.equal(
    "<p>Read our <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/help/en-us/articles/1111111111111111111-privacy-policy\">Privacy Policy</a> and <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/help/en-us/articles/2222222222222222222-terms-of-service\">Terms of Service</a>.</p>",
  )
}
...
pub fn render_article_shortcut_uses_marketing_base_url_test() {
  ...
  result
  |> should.equal(
    "<p>See <a class=\"text-[#4641D9] hover:underline\" href=\"https://asrtal.ru/help/en-us/articles/444-support-guide\">Support guide</a></p>",
  )
}
...
pub fn render_article_shortcut_in_list_test() {
  ...
  let result =
    render_md.render(markdown, "https://asrtal.ru", locale.EnUS, test_data)
...
pub fn render_terms_table_of_contents_and_lists_test() {
  ...
  rendered
  |> string.contains(
    "<a class=\"text-[#4641D9] hover:underline\" href=\"#welcome-to-Astral\">Welcome to Astral</a>",
  )
  |> should.be_true
