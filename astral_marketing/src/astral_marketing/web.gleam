...
import astral_marketing/visionary_slots.{type VisionarySlots}
...
pub fn public_docs_url() -> String {
  "https://astraof.com/docs"
}

pub fn public_bot_docs_url() -> String {
  "https://astraof.com/docs/bots"
}
