...
import astral_marketing/components/feature_card
...
pub fn render(ctx: Context) -> Element(a) {
  ...
  html.section(
    [
      attribute.class(
        "bg-gradient-to-b from-[#0b0b0d] to-[#09090b] px-6 py-20 md:py-32 reveal-section",
      ),
    ],
    [
      html.div([attribute.class("mx-auto max-w-7xl")], [
        html.div([attribute.class("mb-16 md:mb-20 text-center animate-fade-up")], [
          html.h2(
            [
              attribute.class(
          ...
          html.p(
            [
              attribute.class("lead mx-auto max-w-3xl text-zinc-300"),
            ],
            [
              html.text(g_(
                i18n_ctx,
        ...
        html.div(
          [attribute.class("grid gap-8 md:gap-10 grid-cols-1 lg:grid-cols-2 animate-fade-up delay-1")],
          [
            feature_card.render(
              ctx,
              "chats",
            ...
            feature_card.render(
              ctx,
              "server",
              g_(i18n_ctx, "Multi-device sync"),
              g_(
                i18n_ctx,
                "Use Astral across desktop and web with fast sync between your devices.",
              ),
              [
                g_(i18n_ctx, "Desktop + web access"),
                g_(i18n_ctx, "Fast message and settings sync"),
                g_(i18n_ctx, "Consistent experience across sessions"),
                g_(i18n_ctx, "Built for everyday communication"),
              ],
              "dark",
            ),
          ],
