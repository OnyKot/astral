        ...
        html.div([attribute.class("flex flex-col h-full")], [
          ...
          html.p(
            ...
            [
              html.text(g_(
                i18n_ctx,
                "All translations are currently LLM-generated with minimal human revision. We'd love to get real people to help us out localizing Astral into your language! To do so, shoot an email to i18n@astraof.com and we'll be happy to accept your contributions.",
              )),
            ],
          ),
                    ...
                    html.button(
                      ...
                      [
                        ...
                        flags.flag_svg(loc, ctx, [
                          attribute.class("w-10 h-10 rounded shadow-sm"),
                        ]),
                        html.div(
                          [
                            attribute.class(
