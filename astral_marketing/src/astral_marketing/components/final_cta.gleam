...
pub fn render(ctx: Context) -> Element(a) {
  ...
  html.section(
    [
      attribute.class("bg-gradient-to-b from-[#0b0b0d] to-[#09090b]"),
    ],
    [
      html.div(
        [
          attribute.class(
            "rounded-t-3xl bg-gradient-to-b from-[#0b0b0d] to-[#09090b] text-white",
          ),
        ],
        [
          html.div(
            ...
            [
              ...
              html.p(
                [
                  attribute.class(
                    "lead mb-12 md:mb-14 text-zinc-300 text-xl md:text-2xl",
                  ),
                ],
                [
                  html.text(g_(
              ...
              html.a(
                [
                  ...
                  attribute.class(
                    "label inline-block rounded-xl bg-[#18181b] px-10 py-5 md:px-12 md:py-6 text-lg md:text-xl text-indigo-400 transition-colors hover:bg-opacity-90 shadow-lg",
                  ),
                ],
