          ...
          html.div(
            ...
            [
              html.h2([attribute.class("text-xl font-bold text-gray-900")], [
                html.text(g_(i18n_ctx, "Install Astral as an app")),
              ]),
              html.button(
                [
                  attribute.class(
      ...
      html.ol([attribute.class("space-y-4")], [
        ...
        step_item(
          ...
          html.span([attribute.class("text-green-600 font-medium")], [
            html.text(g_(
              i18n_ctx,
              "Done! You can open Astral from your home screen.",
            )),
          ]),
        ),
      ]),
      ...
      html.ol([attribute.class("space-y-4")], [
        ...
        step_item(
          ...
          html.span([attribute.class("text-green-600 font-medium")], [
            html.text(g_(
              i18n_ctx,
              "Done! You can now open Astral as if it were a regular program.",
            )),
          ]),
        ),
      ]),
