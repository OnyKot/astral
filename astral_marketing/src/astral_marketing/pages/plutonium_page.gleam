...
pub fn render(req: wisp.Request, ctx: Context) -> wisp.Response {
  ...
  layout.render(
    ...
    ctx,
    PageMeta(
      title: g_(i18n_ctx, "Astral Plutonium"),
      description: g_(
        i18n_ctx,
...
fn hero_section(ctx: Context) -> Element(a) {
  ...
  hero_base.render(hero_base.HeroConfig(
    icon: icons.astral_premium(Some("#4641D9"), [
    ...
    extra_content: html.div([], [
      html.p(
        ...
        [
          html.text(g_(
            i18n_ctx,
            "Note: Plutonium and Visionary benefits are available on the official Astral service.",
          )),
        ],
      ),
      html.div(
...
fn comparison_section(ctx: Context) -> Element(a) {
  ...
  html.section(
    [
      attribute.class("relative isolate overflow-hidden px-6 py-24 md:py-32"),
    ],
    [
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -top-36 -left-24 h-96 w-96 rounded-full bg-indigo-500/18 blur-3xl",
          ),
        ],
        [],
      ),
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -right-24 top-24 h-[28rem] w-[28rem] rounded-full bg-cyan-400/12 blur-3xl",
          ),
        ],
        [],
      ),
      html.div([attribute.class("mx-auto max-w-6xl")], [
        html.h2(
          [
            attribute.class(
              "motion-reveal display mb-16 md:mb-20 text-center text-white text-4xl md:text-5xl lg:text-6xl",
            ),
          ],
        ...
        html.div(
          ...
          [
            html.div(
              [
                attribute.class(
                  "motion-reveal reveal-card rounded-3xl border border-white/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(255,255,255,0.04))] p-10 md:p-12 text-center backdrop-blur-2xl shadow-[0_22px_50px_rgba(0,0,0,0.35)]",
                ),
              ],
              [
                html.h3(
                  [
                    attribute.class(
                      "title mb-4 text-white text-2xl md:text-3xl",
                    ),
                  ],
                  [
                ...
                html.p(
                  [
                    attribute.class(
                      "text-4xl md:text-5xl font-bold text-zinc-100 mb-3",
                    ),
                  ],
                  [
                ...
                html.p([attribute.class("body-lg text-zinc-300/80")], [
            ...
            html.div(
              [
                attribute.class(
                  "motion-reveal reveal-card relative rounded-3xl border border-indigo-200/35 bg-[linear-gradient(180deg,rgba(99,102,241,0.22),rgba(255,255,255,0.04))] p-10 md:p-12 text-center backdrop-blur-2xl shadow-[0_30px_65px_rgba(0,0,0,0.5)]",
                ),
              ],
              [
                html.div(
                  [
                    attribute.class(
                      "label absolute -top-4 left-1/2 -translate-x-1/2 rounded-full border border-indigo-200/40 bg-indigo-500/55 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-white shadow-lg backdrop-blur-md",
                    ),
                  ],
                ...
                html.p(
                  [
                    attribute.class(
                      "text-4xl md:text-5xl font-bold text-indigo-200 mb-3",
                    ),
                  ],
                  [
                    html.text(monthly_price <> g_(i18n_ctx, "/mo")),
                ...
                html.p([attribute.class("body-lg text-zinc-200/90")], [
                  html.text(
                    g_(i18n_ctx, "or")
                    <> " "
                    <> yearly_price
        ...
        html.div([attribute.class("overflow-x-auto")], [
          html.table(
            [
              attribute.class(
                "motion-reveal motion-delay-2 w-full border-collapse overflow-hidden rounded-3xl border border-white/12 bg-white/4 backdrop-blur-2xl shadow-[0_22px_50px_rgba(0,0,0,0.35)]",
              ),
              attribute.style("table-layout", "fixed"),
            ],
            [
              html.thead([attribute.class("bg-white/6")], [
                html.tr([], [
                  html.th(
                    [
                      attribute.class(
                        "label border-b border-white/10 px-4 py-3 text-left text-white/80 w-1/2",
                      ),
                    ],
                  ...
                  html.th(
                    [
                      attribute.class(
                        "label border-b border-white/10 px-2 sm:px-3 py-3 text-center text-white/70 w-1/4 text-xs sm:text-sm",
                      ),
                    ],
                    [html.text(g_(i18n_ctx, "Free"))],
                  ),
                  html.th(
                    [
                      attribute.class(
                        "label border-b border-white/10 px-2 sm:px-3 py-3 text-center text-indigo-200 w-1/4 text-xs sm:text-sm",
                      ),
                    ],
                    [html.text(g_(i18n_ctx, "Plutonium"))],
                  ),
        ...
        html.div([attribute.class("mt-12 md:mt-16 text-center")], [
          html.a(
            [
              ...
              attribute.class(
                "motion-reveal inline-flex items-center justify-center gap-3 rounded-2xl border border-indigo-200/45 bg-white px-10 py-4 md:px-12 md:py-5 text-lg md:text-xl font-black tracking-wide text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-zinc-200 shadow-[0_18px_45px_rgba(255,255,255,0.22)]",
              ),
            ],
            [
              icons.sparkle([attribute.class("h-5 w-5 text-indigo-600")]),
...
fn comparison_row(
  ...
  let badge_elements = case badge {
    Some(label) -> [
      html.span(
        [
          attribute.class(
            "caption inline-flex items-center rounded-full border border-indigo-300/35 bg-indigo-500/10 px-3 py-1 text-[0.6rem] font-semibold uppercase tracking-[0.2em] text-indigo-200",
          ),
        ],
        [html.text(label)],
      ),
  ...
  html.tr([attribute.class("border-b border-white/8")], [
    html.td([attribute.class("body px-4 py-3 text-zinc-100")], [
      html.div(
    ...
    html.td(
      [
        attribute.class(
          "body px-2 sm:px-3 py-3 text-center text-zinc-300/80 text-xs sm:text-sm",
        ),
      ],
      [
    ...
    html.td(
      [
        attribute.class(
          "label px-2 sm:px-3 py-3 text-center text-indigo-200 text-xs sm:text-sm",
        ),
      ],
      [
...
fn comparison_check_row(
  ...
  html.tr([attribute.class("border-b border-white/8")], [
    ...
    html.td([attribute.class("px-3 py-3 text-center")], [
      case free_has {
        True -> icons.check([attribute.class("h-5 w-5 mx-auto text-green-500")])
        False -> icons.x([attribute.class("h-5 w-5 mx-auto text-zinc-500")])
      },
    ]),
    html.td([attribute.class("px-3 py-3 text-center")], [
      case plutonium_has {
        True ->
          icons.check([attribute.class("h-5 w-5 mx-auto text-indigo-200")])
        False -> icons.x([attribute.class("h-5 w-5 mx-auto text-zinc-500")])
      },
    ]),
  ])
  ...
  html.section(
    ...
    [
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -top-36 -right-24 h-96 w-96 rounded-full bg-indigo-500/16 blur-3xl",
          ),
        ],
        [],
      ),
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -bottom-32 -left-24 h-[26rem] w-[26rem] rounded-full bg-cyan-400/10 blur-3xl",
          ),
        ],
        [],
      ),
        ...
        html.div(
          ...
          [
            ...
            feature_card(
              ...
              g_(
                i18n_ctx,
                "Use your favorite emojis and stickers from any community, anywhere across Astral.",
              ),
              None,
            ),
            feature_card(
            ...
            feature_card(
              ...
              g_(
                i18n_ctx,
                "Upload and use your own notification sounds to personalize your Astral experience.",
              ),
              Some(g_(i18n_ctx, "Beta")),
            ),
            feature_card(
...
fn feature_card(
  ...
  let icon = case icon_name {
    "sparkle" ->
      icons.sparkle([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
    "video" ->
      icons.video([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
    "video_camera" ->
      icons.video_camera([
        attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200"),
      ])
    "user_circle" ->
      icons.user_circle([
        attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200"),
    ...
    "rocket" ->
      icons.rocket([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
    "hash" ->
      icons.hash([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
    "gif" ->
      icons.gif([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
    "arrow_up" ->
      icons.arrow_up([
        attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200"),
      ])
    "smiley" ->
      icons.smiley([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
    _ ->
      icons.sparkle([attribute.class("h-8 w-8 md:h-10 md:w-10 text-indigo-200")])
  }
  ...
  let badge_nodes = case badge {
    Some(label) -> [
      html.div(
        [
          attribute.class(
            "caption absolute top-4 right-4 rounded-full border border-indigo-200/35 bg-indigo-500/40 px-3 py-1 text-[0.65rem] font-semibold uppercase text-white shadow-lg backdrop-blur-md",
          ),
        ],
        [html.text(label)],
      ),
  ...
  let card_children =
    list.append(badge_nodes, [
      html.div(
        [
          attribute.class(
            "inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-2xl border border-indigo-200/20 bg-indigo-500/14 mb-5",
          ),
        ],
        [icon],
      ),
      html.h3([attribute.class("title mb-3 text-white text-xl md:text-2xl")], [
        html.text(title),
      ]),
      html.p([attribute.class("body-lg text-zinc-200/90 leading-relaxed")], [
  ...
  html.div(
    [
      attribute.class(
        "motion-reveal reveal-card relative rounded-3xl border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.11),rgba(255,255,255,0.04))] p-8 md:p-10 backdrop-blur-2xl shadow-[0_22px_50px_rgba(0,0,0,0.35)]",
      ),
    ],
    card_children,
  )
...
fn visionary_section(ctx: Context) -> Element(a) {
  ...
  html.section(
    [
      ...
      attribute.class(
        "relative isolate overflow-hidden bg-gradient-to-b from-black to-gray-900 px-6 py-24 md:py-32 text-white",
      ),
    ...
    [
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -top-40 -left-24 h-96 w-96 rounded-full bg-indigo-500/20 blur-3xl",
          ),
        ],
        [],
      ),
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -bottom-32 -right-24 h-[26rem] w-[26rem] rounded-full bg-cyan-400/10 blur-3xl",
          ),
        ],
        [],
      ),
      html.div([attribute.class("mx-auto max-w-7xl")], [
        html.div([attribute.class("motion-reveal text-center mb-16 md:mb-20")], [
        ...
        html.div(
          ...
          [
            ...
            visionary_benefit(
              ctx,
              "globe",
              g_(i18n_ctx, "Lifetime Operator Access"),
              g_(i18n_ctx, "Priority support and Operators community access"),
            ),
            visionary_benefit(
              ctx,
              "medal",
...
fn visionary_benefit(
  ...
  html.div(
    [
      attribute.class(
        "motion-reveal reveal-card rounded-3xl border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.11),rgba(255,255,255,0.04))] p-8 md:p-10 text-center backdrop-blur-2xl shadow-[0_22px_50px_rgba(0,0,0,0.35)]",
      ),
    ],
    [
      html.div(
...
fn self_hosting_section(ctx: Context) -> Element(a) {
  ...
  let limited_offer_text =
    g_(
      i18n_ctx,
      "Get lifetime Plutonium on Astral.app plus Operator Access. Pay {0} one-time. Available until October 1, 2026 or when {1} slots are claimed.",
    )
  ...
  html.section(
    ...
    [
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -top-36 -left-24 h-96 w-96 rounded-full bg-indigo-500/14 blur-3xl",
          ),
        ],
        [],
      ),
      ...
      html.div([attribute.class("mx-auto max-w-7xl")], [
        html.div([attribute.class("motion-reveal text-center mb-16 md:mb-20")], [
          html.h2(
            ...
            [
              html.text(g_(i18n_ctx, "Operator Access")),
            ],
          ),
          html.p(
            [
              attribute.class(
                "lead text-zinc-200/90 max-w-3xl mx-auto mb-3 text-xl md:text-2xl",
              ),
            ],
            [
              html.text(g_(
                i18n_ctx,
                "Astral stays independent and community-funded.",
              )),
            ],
          ),
          html.p(
            [attribute.class("body-lg text-zinc-300/80 max-w-3xl mx-auto")],
            [
              html.text(g_(
                i18n_ctx,
                "Operator Access is optional: choose it if you want priority support and team contact.",
              )),
            ],
          ),
        ]),
        html.div(
          ...
          [
            html.div(
              [
                attribute.class(
                  "motion-reveal reveal-card rounded-3xl border border-white/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(255,255,255,0.04))] p-10 md:p-12 backdrop-blur-2xl shadow-[0_22px_50px_rgba(0,0,0,0.35)]",
                ),
              ],
              [
                html.div([attribute.class("mb-4 flex justify-center")], [
                  icons.globe([attribute.class("h-16 w-16 text-zinc-500")]),
                ]),
                html.h3(
                  [
                    attribute.class("title text-white mb-2 text-center"),
                  ],
                  [
                    html.text(g_(i18n_ctx, "Astral Standard")),
                  ],
                ),
                html.div([attribute.class("mb-6 text-center")], [
                  html.span([attribute.class("display text-zinc-100")], [
                    html.text(free_price),
                  ]),
                  html.span([attribute.class("body-lg text-zinc-300/80")], [
                    html.text(g_(i18n_ctx, "/forever")),
                  ]),
                ]),
            ...
            html.div(
              [
                attribute.class(
                  "motion-reveal reveal-card rounded-3xl border border-indigo-200/35 bg-[linear-gradient(180deg,rgba(99,102,241,0.20),rgba(255,255,255,0.04))] p-10 md:p-12 backdrop-blur-2xl shadow-[0_30px_65px_rgba(0,0,0,0.5)]",
                ),
              ],
              [
                html.div([attribute.class("mb-4 flex justify-center")], [
                  icons.globe([attribute.class("h-16 w-16 text-indigo-200")]),
                ]),
                html.h3(
                  [
                    attribute.class("title text-white mb-2 text-center"),
                ...
                html.div([attribute.class("mb-6 text-center")], [
                  html.span([attribute.class("display text-indigo-200")], [
                    html.text(operator_price),
                  ]),
                  html.span(
                    [attribute.class("body-lg text-zinc-300/80 block")],
                    [
                ...
                html.div([attribute.class("space-y-3 mb-6")], [
                  ...
                  benefit_item(
                    ctx,
                    g_(i18n_ctx, "Access to Astral Operators community"),
                  ),
            ...
            html.div([attribute.class("text-center")], [
              ...
              html.h3(
                ...
                [
                  html.text(g_(
                    i18n_ctx,
                    "Limited Offer: Visionary includes Operator Access",
                  )),
                ],
              ),
              html.p(
              ...
              html.p(
                ...
                [
                  html.text(g_(
                    i18n_ctx,
                    "After the offer ends, Operator Access stays available on its own.",
                  )),
                ],
              ),
              html.a(
                ...
                [html.text(g_(i18n_ctx, "Get Visionary + Operator Access"))],
              ),
            ]),
          ],
        ),
...
fn benefit_item(_ctx: Context, text: String) -> Element(a) {
  html.div([attribute.class("flex items-start gap-3")], [
    icons.check([attribute.class("h-5 w-5 shrink-0 mt-0.5 text-indigo-200")]),
    html.span([attribute.class("body text-zinc-200/90")], [html.text(text)]),
  ])
}
...
fn cta_section(ctx: Context) -> Element(a) {
  ...
  html.section(
    [
      attribute.class("relative isolate overflow-hidden"),
    ],
    [
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -top-40 -right-24 h-96 w-96 rounded-full bg-indigo-500/18 blur-3xl",
          ),
        ],
        [],
      ),
      html.div(
        [
          attribute.class(
            "pointer-events-none absolute -bottom-40 -left-24 h-[28rem] w-[28rem] rounded-full bg-cyan-400/10 blur-3xl",
          ),
        ],
        [],
      ),
      html.div(
        ...
        [
          html.div(
            [
              attribute.class(
                "motion-reveal mx-auto max-w-5xl px-6 py-24 md:py-32 lg:py-40 text-center",
              ),
            ],
            [
              html.h2(
              ...
              html.p(
                ...
                [
                  html.text(g_(
                    i18n_ctx,
                    "Create your Astral account to get that sweet Plutonium while it's hot.",
                  )),
                ],
              ),
              html.a(
                ...
                [html.text(g_(i18n_ctx, "Join Astral"))],
              ),
            ],
          ),
        ],
