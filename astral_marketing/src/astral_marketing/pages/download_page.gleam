...
const windows_version = "1.6.0"

const android_version = "1.6"

const linux_version = "1.6.0"
...
pub fn render(req: wisp.Request, ctx: Context) -> wisp.Response {
  ...
  layout.render(
    ...
    PageMeta(
      ...
      description: tr(
        ctx,
        "Скачайте Astral для Windows, Android и Linux. На iPhone, iPad и macOS можно сразу работать через браузер.",
        "Download Astral for Windows, Android APK, and Linux. Use Astral on the web from any browser.",
      ),
      og_type: "website",
    ),
    content,
...
fn hero_section(ctx: Context) -> Element(a) {
  hero_base.render(hero_base.HeroConfig(
    ...
    description: tr(
      ctx,
      "Установщик для Windows, APK для Android и Linux-сборки уже доступны",
  ...
  html.div([attribute.class("mt-12 md:mt-16 w-full max-w-5xl mx-auto")], [
    html.div([attribute.class("mb-10 download-release-panel p-6 md:p-8")], [
      html.div(
        [
          attribute.class(
            "mb-7 flex flex-col gap-3 text-left md:flex-row md:items-end md:justify-between",
          ),
        ],
        [
          html.div([], [
            ...
            html.h2(
              [
                attribute.class(
                  "mt-4 text-2xl font-semibold text-white md:text-4xl",
                ),
              ],
              [
                html.text("Astral for Windows + Android + Linux 1.6.0"),
              ],
            ),
          ]),
          html.p(
            [
              attribute.class(
                "max-w-xl text-sm leading-relaxed text-[hsl(var(--muted-foreground))] md:text-right md:text-base",
              ),
            ],
            [
              html.text(tr(
                ctx,
                "Windows, Android и Linux-сборки отдаются через основные download endpoints для Astral 1.6.0.",
                "Windows, Android, and Linux builds are served through the main download endpoints for Astral 1.6.0.",
              )),
            ],
          ),
        ],
          ...
          html.div(
            ...
            [
              ...
              html.p(
                ...
                [
                  html.text("AppImage / .deb / tar.gz - v" <> linux_version),
                ],
              ),
            ],
          ),
    ...
    html.div(
      [
        attribute.class(
          "marketing-panel max-w-3xl mx-auto text-center px-6 py-8 md:px-10 md:py-10",
        ),
      ],
      [
        html.div([attribute.class("mb-8 grid gap-4 text-left md:grid-cols-3")], [
          detail_card(
            ...
            tr(
              ctx,
              "Установщик Windows, Android APK и Linux-пакеты уже готовы для прямой загрузки.",
              "Windows installer, Android APK, and Linux packages are ready for direct download.",
            ),
          ),
          detail_card(
            ...
            tr(
              ctx,
              "На iPhone, iPad и macOS полноценно работает веб-версия без ожидания нативного клиента.",
              "iPhone, iPad, and macOS can use the full web app immediately.",
            ),
          ),
          detail_card(
        ...
        html.h3(
          [attribute.class("text-lg md:text-xl font-semibold text-white")],
          [
            html.text(tr(
              ctx,
              "Используйте Astral в браузере на остальных устройствах",
              "Use Astral everywhere else in the browser",
            )),
          ],
        ),
        html.p(
          ...
          [
            html.text(tr(
              ctx,
              "Windows, Android и Linux уже доступны как отдельные сборки. На iPhone, iPad и macOS можно открыть Astral в браузере, пока нативные версии продолжают развиваться.",
              "Windows installer, Android APK, and Linux packages are live. On iPhone, iPad, and macOS, open Astral in your browser while native builds continue.",
            )),
          ],
        ),
        html.ul(
          ...
          [
            html.li([], [
              html.text(tr(
                ctx,
                "Добавьте Astral на домашний экран, чтобы убрать интерфейс браузера.",
                "Add Astral to your home screen to hide the browser UI.",
              )),
            ]),
            html.li([], [
              html.text(tr(
                ctx,
                "Получайте бейджи уведомлений прямо на иконке приложения.",
                "See badge counts on the app icon.",
              )),
            ]),
            html.li([], [
              html.text(tr(
                ctx,
                "Получайте push-уведомления, когда вы не в приложении.",
        ...
        html.div(
          [
            attribute.class(
              "mt-10 rounded-[24px] border border-white/10 bg-black/20 p-6 md:p-8",
            ),
          ],
          [
            html.h4(
              ...
              [
                html.text(tr(
                  ctx,
                  "Нужна следующая платформа?",
                  "Need another platform next?",
                )),
              ],
            ),
            html.p(
            ...
            html.div(
              ...
              [
                support_cta_button(
                  ...
                  tr(
                    ctx,
                    "Связаться с продуктовой командой",
                    "Contact product team",
                  ),
                  tr(
                    ctx,
                    "Роадмап, обратная связь и запросы по продукту",
                    "Roadmap, feedback, and product requests",
                  ),
                  True,
                ),
              ],
...
fn detail_card(
  ...
  html.div(
    [
      attribute.class("marketing-panel reveal-card rounded-[24px] p-4 md:p-5"),
    ],
    [
      html.div(
        [
          attribute.class(
            "inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-white/8",
          ),
        ],
        [
          icon,
      ...
      html.h4(
        [attribute.class("mt-4 text-sm font-semibold text-white md:text-base")],
        [
          html.text(title),
        ],
      ),
      html.p(
        [
          attribute.class(
            "mt-2 text-sm leading-relaxed text-[hsl(var(--muted-foreground))]",
          ),
        ],
        [
