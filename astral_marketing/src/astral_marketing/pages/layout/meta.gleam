...
pub fn default_page_meta() -> PageMeta {
  PageMeta(
    title: "Astral: A chat app that puts you first",
    description: "Astral is an independent instant messaging and VoIP platform. Built for friends, groups, and communities.",
    og_type: "website",
  )
}
...
pub fn build_meta_tags(ctx: Context, page_meta: PageMeta) -> List(Element(a)) {
  [
    ...
    html.meta([attribute.name("author"), attribute.content("Astral Team")]),
