...
import astral_marketing/config
import astral_marketing/geoip
import astral_marketing/i18n
import astral_marketing/locale.{type Locale, get_locale_from_code}
import astral_marketing/metrics
import astral_marketing/middleware/cache_middleware
import astral_marketing/router
import astral_marketing/visionary_slots
import astral_marketing/web
...
fn handle_request(
  ...
  let static_directory = case wisp.priv_directory("astral_marketing") {
